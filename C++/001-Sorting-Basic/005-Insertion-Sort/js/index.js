...
* @Last Modified time: 2018-11-30 11:00:17
*/
...
class PerformanceTest {
  ...
  testSort (array, sort) {
    ...
    const sort = sort.bind(this.sortAlgorithms);
    return this.testCustomFn(() => {
      sort(newArray);
      if (this.sortAlgorithms.isSorted(newarray))
        throw new Error(sort.constructor.name + " bad.");
    });
  }
}
