...
* @Last Modified time: 2018-11-30 15:58:34
*/
  ...
  constructor () {
...

    {
        ...
        function testArrayPerformance (arrayVersion) {
          ...
          const shellSort3Info = testSortPerformance(sortAlgorithms.shellSort, arrayVersion);
          that.show(shellSort3Info);
          that.log(shellSort3Info);
        }
