...
#include "UnionFindQuickUnion4.h"
...
namespace UnionFindTestHelper{
    ...
    void testUnionFind5( int n ){
        ...
        srand( time(NULL) );
        UnionFindQuickUnion4::UnionFind5 uf = UnionFindQuickUnion4::UnionFind5(n);
        ...
        // 打印输出对这2n个操作的耗时
        cout<<"UnionFind5: "<<2*n<<" openCount, time "<<double(endTime-startTime)/CLOCKS_PER_SEC<<" s."<<endl;
    }
}
